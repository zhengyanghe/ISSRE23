...
; <label>:13                                      ; preds = %9
  ...
  store float 0x3FE0A3D700000000, float* %21, align 4
  br label %22
...
define i32 @load(%struct.BPNN* %net) #0 {
  ...
  %k = alloca i32, align 4
  store %struct.BPNN* %net, %struct.BPNN** %1, align 8
  %2 = load i32* @layer_size, align 4
  store i32 %2, i32* %nr, align 4
  %3 = load i32* %nr, align 4
  %4 = load i32* %nc, align 4
  %5 = mul nsw i32 %3, %4
  store i32 %5, i32* %imgsize, align 4
  %6 = load %struct.BPNN** %1, align 8
  %7 = getelementptr inbounds %struct.BPNN* %6, i32 0, i32 3
  %8 = load float** %7, align 8
  store float* %8, float** %units, align 8
  store i32 1, i32* %k, align 4
  store i32 0, i32* %i, align 4
  br label %9
...
; <label>:13                                      ; preds = %9
  %14 = load i32* %k, align 4
  %15 = sext i32 %14 to i64
  %16 = load float** %units, align 8
  %17 = getelementptr inbounds float* %16, i64 %15
  store float 0x3FE0A3D700000000, float* %17, align 4
