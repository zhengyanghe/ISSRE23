...
with open('input_list.txt','r') as fr:
    input = fr.readlines()
i = 0
timestack = [0 for i in range(30)]
cyclestack = [0 for i in range(30)]
L1dataStack = [0 for i in range(30)]
L1storestack = [0 for i in range(30)]
L2stack = [0 for i in range(30)]
branchstack = [0 for i in range(30)]
dtlbstack = [0 for i in range(30)]
inststack = [0 for i in range(30)]
BBstack = [0 for i in range(30)]
Elestack = [0 for i in range(30)]
...
# form is output_file.write("%i %i %i: %.4f\n"%(inputArg1, inputArg2, inputArg3,total_sdc*1000))
	...
	BBstack[i] = float(total_BB)
	Elestack[i] = float(total_Ele)
...
Eleco = pearsonr(timestack,Elestack)
instco = pearsonr(timestack,inststack)
BBco = pearsonr(timestack,BBstack)
...
with open ('fitness-correlation','w') as fr:
	...
	fr.write(str(BBco[0]) + " " + str(BBco[1])+ "\n")
	fr.write(str(instco[0]) + " " + str(instco[1])+ "\n")
	fr.write(str(Eleco[0]) + " " + str(Eleco[1]))