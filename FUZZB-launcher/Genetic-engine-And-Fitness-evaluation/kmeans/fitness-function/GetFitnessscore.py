...
total_fitness = total_time + result[0]*total_cycle + result[1]*total_L1data + result[2]*total_L1dstore + result[3]*total_L2 + result[4]*total_branch + result[5]*total_dtlb + result[6]*total_BB + result[7]*total_inst + result[8]*total_Ele
