; ModuleID = 'Input/pathfinder-llfi_index.ll'
...
define void @_Z4initiPPc(i32 %argc, i8** %argv) #0 {
  call void @calculateExecCount(i64 1)
...
; <label>:5                                       ; preds = %0
  call void @calculateExecCount(i64 14)
...
; <label>:35                                      ; preds = %50, %16
  call void @calculateExecCount(i64 50)
...
; <label>:39                                      ; preds = %35
  call void @calculateExecCount(i64 54)
...
; <label>:50                                      ; preds = %39
  call void @calculateExecCount(i64 66)
...
; <label>:53                                      ; preds = %35
  call void @calculateExecCount(i64 70)
...
; <label>:62                                      ; preds = %84, %53
  call void @calculateExecCount(i64 81)
...
; <label>:67                                      ; preds = %80, %66
  call void @calculateExecCount(i64 87)
...
; <label>:71                                      ; preds = %67
  call void @calculateExecCount(i64 91)
...
; <label>:80                                      ; preds = %71
  call void @calculateExecCount(i64 101)
...
; <label>:84                                      ; preds = %83
  call void @calculateExecCount(i64 106)
...
; <label>:88                                      ; preds = %104, %87
  call void @calculateExecCount(i64 112)
...
; <label>:92                                      ; preds = %88
  call void @calculateExecCount(i64 116)
...
; <label>:104                                     ; preds = %92
  call void @calculateExecCount(i64 129)
...
; <label>:108                                     ; preds = %133, %107
  call void @calculateExecCount(i64 135)
...
; <label>:113                                     ; preds = %128, %112
  call void @calculateExecCount(i64 141)
...
; <label>:117                                     ; preds = %113
  call void @calculateExecCount(i64 145)
...
; <label>:128                                     ; preds = %117
  call void @calculateExecCount(i64 156)
...
define void @_Z5fatalPc(i8* %s) #0 {
  call void @calculateExecCount(i64 167)
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  call void @calculateExecCount(i64 173)
...
define void @_Z3runiPPc(i32 %argc, i8** %argv) #0 {
  call void @calculateExecCount(i64 183)
...
; <label>:14                                      ; preds = %101, %0
  call void @calculateExecCount(i64 212)
...
; <label>:19                                      ; preds = %14
  call void @calculateExecCount(i64 217)
...
; <label>:23                                      ; preds = %97, %19
  call void @calculateExecCount(i64 225)
...
; <label>:27                                      ; preds = %23
  call void @calculateExecCount(i64 229)
...
; <label>:35                                      ; preds = %27
  call void @calculateExecCount(i64 238)
...
; <label>:44                                      ; preds = %35
  call void @calculateExecCount(i64 247)
  %45 = load i32* %min, align 4, !llfi_index !247
  br label %53, !llfi_index !248

; <label>:46                                      ; preds = %35
  call void @calculateExecCount(i64 249)
...
; <label>:55                                      ; preds = %53, %27
  call void @calculateExecCount(i64 259)
...
; <label>:60                                      ; preds = %55
  call void @calculateExecCount(i64 264)
...
; <label>:69                                      ; preds = %60
  call void @calculateExecCount(i64 273)
  %70 = load i32* %min, align 4, !llfi_index !273
  br label %78, !llfi_index !274

; <label>:71                                      ; preds = %60
  call void @calculateExecCount(i64 275)
...
; <label>:80                                      ; preds = %78, %55
  call void @calculateExecCount(i64 285)
...
; <label>:97                                      ; preds = %80
  call void @calculateExecCount(i64 303)
...
; <label>:101                                     ; preds = %100
  call void @calculateExecCount(i64 308)
...
; <label>:105                                     ; preds = %116, %104
  call void @calculateExecCount(i64 314)
...
; <label>:109                                     ; preds = %105
  call void @calculateExecCount(i64 318)
...
; <label>:116                                     ; preds = %109
  call void @calculateExecCount(i64 325)
...
; <label>:119                                     ; preds = %105
  call void @calculateExecCount(i64 329)
...
; <label>:121                                     ; preds = %132, %119
  call void @calculateExecCount(i64 332)
...
; <label>:125                                     ; preds = %121
  call void @calculateExecCount(i64 336)
...
; <label>:132                                     ; preds = %125
  call void @calculateExecCount(i64 343)
...
; <label>:135                                     ; preds = %121
  call void @calculateExecCount(i64 347)
...
; <label>:139                                     ; preds = %135
  call void @calculateExecCount(i64 351)
...
; <label>:141                                     ; preds = %139, %135
  call void @calculateExecCount(i64 354)
...
; <label>:144                                     ; preds = %141
  call void @calculateExecCount(i64 357)
...
; <label>:146                                     ; preds = %144, %141
  call void @calculateExecCount(i64 360)
...
; <label>:149                                     ; preds = %146
  call void @calculateExecCount(i64 363)
...
; <label>:151                                     ; preds = %149, %146
  call void @calculateExecCount(i64 366)
...
; <label>:154                                     ; preds = %151
  call void @calculateExecCount(i64 369)
...
declare void @calculateExecCount(i64)

declare void @calculateAndDumpResult()
